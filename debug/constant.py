...
class _Const(object):
    ...
    def SWING_INTERPRET_RES():
        return {'000': '준비 스윙 속도 부족',
                ...
                '100': '임팩트 스윙 속도 부족',
                '101': '임팩트 스윙 속도 부족',
                '110': '임팩트 스윙 손목 방향 잘못됨',
                '120': '110 임팩트 스윙 손목 회전 미사용',
                '130': '110 임팩트 스윙 손목 회전 이상',
                '131': '110 임팩트 스윙 손목 회전 이상',
                '200': '임팩트 이후 자세가 부자연스러움',
                '201': '임팩트 이후 자세가 부자연스러움',
                '210': '손목회전이 민첩하지 않음',
                '211': '손목회전이 민첩하지 않음',
                ...
                '510': '백스윙 궤적 적절',
                '600': '임팩트 스윙 속도 적절',
                '610': '임팩트 스윙 시 손목을 올바르게 회전',
                '700': '임팩트 이후 자세가 안정적',
                '710': '임팩트 이후 손목회전이 자연스러움',
                '720': '임팩트 이후 손목이 꺾이지 않았음',
                }
