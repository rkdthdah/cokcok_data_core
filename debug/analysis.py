...
a = SwingAnalysis(pd.read_csv(CONST.CURRENT_PATH + '/k fh.csv'))
print(a.analysis(CONST.CLASS_STROKE[7], False))
print(a.score())
# print(a.max)
print(a.interpret())
print(a.res_prepare)
...
plt.subplot(2, 1, 1)
plt.plot(a.data.index, a.data[CONST.ACCX], label='X')
plt.plot(a.data.index, a.data[CONST.ACCY], label='Y')
plt.plot(a.data.index, a.data[CONST.ACCZ], label='Z')
plt.xlabel('Index')
plt.ylabel('acceleration')
plt.legend()

plt.subplot(2, 1, 2)
plt.plot(a.data.index, a.data[CONST.RVP], label='Pitch')
plt.plot(a.data.index, a.data[CONST.RVR], label='Roll')
plt.plot(a.data.index, a.data[CONST.RVY], label='Yaw')
plt.xlabel('Index')
